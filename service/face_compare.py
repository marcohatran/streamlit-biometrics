...
def test_image(image_to_check, known_face_encodings):
    ...
    if len(unknown_encodings) == 1:
        for unknown_encoding in unknown_encodings:
            result = face_recognition.compare_faces(known_face_encodings, unknown_encoding, 0.5)
...
def main(known_people_folder: object, image_to_check: object) -> object:
    known_names, known_face_encodings = scan_known_people(known_people_folder)
    distance, result = test_image(image_to_check, known_face_encodings)
